...
const ProjectBanner: React.FC<Props> = ({ project, imageAlignment, href }) => {
  return (
    <div id="projects" className="grid grid-cols-1 lg:grid-cols-2 h-full lg:h-[50vh] w-full">
      ...
      <div className={`w-full py-32 h-full flex gap-y-4 justify-center px-20 lg:px-40 flex-col border-[1px] bg-gradient-to-tr from-base-300 via-base-100 to-base-200 border-gray-800 order-2 ${imageAlignment === 'left' ? 'lg:order-2' : 'lg:order-1'}`}>
