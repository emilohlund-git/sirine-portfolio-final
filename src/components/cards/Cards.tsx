    ...
    <div className="p-4 lg:p-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 place-items-center gap-4 w-full">
      <Card text='UI/UX'>
        <div className="flex flex-col self-end gap-y-4 max-w-[80%]">
          <DesignIcon />
          <h3 className="font-medium text-2xl text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-300 to-gray-900">UI/UX</h3>
      ...
      <Card text='Design & Creative'>
        <div className="flex flex-col self-end gap-y-4 max-w-[80%]">
          <BrandingIcon />
          <h3 className="font-medium text-2xl text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-300 to-gray-900">Branding</h3>
      ...
      <Card text='Product Design'>
        <div className="flex flex-col self-end gap-y-4 max-w-[80%]">
          <ProductDesign />
          <h3 className="font-medium text-2xl text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-300 to-gray-900">Product Design</h3>
