  ...
  return (
    <>
        ...
        <>
          ...
          <GridContainer cols={2}>
            <GridBox variant="center" spotlight={true} background="transparent" style={{
              ...
              <GridBoxHeader className="text-white lg:text-[5rem]"><span className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 text-[10rem] lg:text-[25rem] text-opacity-50 select-none text-white opacity-20">UX</span> Research</GridBoxHeader>
            </GridBox>
          ...
          <GridBox variant={'no-padding'} background="white" className={`${!shouldBeCarouselProjectMediaArray(findings) ? 'p-14' : ''}`}>
            {
              shouldBeCarouselProjectMediaArray(findings) ?
                ...
                :
                findings[0].media ?
                  <ProjectMedia media={findings[0]} className="h-[30rem] lg:h-[40rem]" style={{
                    objectFit: 'contain'
                  }} />
                  : null
            }
      ...
      {persona && affinity_map && user_flow && navigation_map &&
        <GridContainer cols={2}>
          <GridBox variant="no-padding" background="white" className="order-last lg:order-first lg:p-10">
            <div className="w-full h-full relative">
              <ProjectMedia media={persona.expand.media[0]} className="h-[30rem] lg:h-[40rem]" style={{
                objectFit: 'contain'
              }} />
            </div>
          </GridBox>
      ...
      {affinity_map &&
        <GridContainer cols={2}>
          ...
          <GridBox variant="no-padding" background="white" className="lg:p-10">
            <div className="w-full h-full relative">
              <ProjectMedia media={affinity_map.expand.media[0]} className="h-[30rem] lg:h-[40rem]" style={{
                objectFit: 'contain'
              }} />
            </div>
          </GridBox>
      ...
      {user_flow &&
        <GridContainer cols={2}>
          <GridBox variant="no-padding" background="white" className="order-last lg:order-first lg:p-10">
            <div className="w-full h-full relative">
              <ProjectMedia media={user_flow.expand.media[0]} className="h-[30rem] lg:h-[40rem]" style={{
                objectFit: 'contain'
              }} />
            </div>
          </GridBox>
      ...
      {navigation_map &&
        <GridContainer cols={2}>
          ...
          <GridBox variant="no-padding" background="white">
            <div className="w-full h-full relative">
              <ProjectMedia media={navigation_map.expand.media[0]} className="h-[30rem] lg:h-[40rem]" style={{
                objectFit: 'contain'
              }} />
            </div>
          </GridBox>
      ...
      {project.problem &&
        <GridContainer cols={2}>
          <GridBox variant="center" background="transparent" style={{
            ...
            <GridBoxHeader className="text-white lg:text-[5rem]"><span className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 text-[10rem] lg:text-[25rem] text-opacity-50 select-none text-white opacity-20">UI</span> Brand Guidelines</GridBoxHeader>
          </GridBox>
          <GridBox background="transparent">
      ...
      {brand_colors &&
        <GridContainer cols={2}>
          ...
          <GridBox variant="no-padding" background="white" className="h-full lg:p-10">
            {brand_colors.expand.media.filter((media) => media.type === 'image').map((media) =>
              <div key={media.id} className="w-full h-full relative">
                <ProjectMedia media={media} className="h-[30rem]" style={{
                  objectFit: 'contain'
                }} />
              </div>
            )}
