...
const GradientButton: React.FC<Props> = ({ children, href, className, onClick }) => {
  return (
    <a onClick={onClick} href={href} className={`relative cursor-pointer inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-none shadow-2xl group ${className}`}>
